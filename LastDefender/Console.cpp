...
|                                                                              |
\*----------------------------------------------------------------------------*/
void mostratexto ( int x, int y, const char *texto, WORD atributos )
{
	HANDLE hConsole;			// Handle para a janela
	COORD coord = { x, y };		// Posição do cursor
...
|                                                                              |
\*----------------------------------------------------------------------------*/
void mostrar(int x, int y, WORD atributos, const char *texto)
{
	HANDLE hConsole;			// Handle para a janela
	COORD coord = { x, y };		// Posição do cursor
	DWORD dChar;				// Número de caracteres impressos
...
|                                                                              |
\*----------------------------------------------------------------------------*/
void mostrar(int x, int y, WORD atributos, int valor)
{
	HANDLE hConsole;			// Handle para a janela
	COORD coord = { x, y };		// Posição do cursor
	DWORD dChar;				// Número de caracteres impressos
...
|                                                                              |
|   Descrição:                                                                 |
|       Mostra um caracter em determinada posição da tela com cores diferentes.|
|                                                                              |
|   Parâmetros:                                                                |
|       x -> coordenada horizontal.                                            |
|		y -> coordenada vertical.									 		   |
...
|       Exemplos:                                                              |
|         //Mostra a frase em letras amarelas e fundo branco                   |
|         mostratexto(5,5, FOREGROUND_YELLOW | BACKGROUND_WHITE, 'a');         |
|                                                                              |
|   Retorno:                                                                   |
|                                                                              |
\*----------------------------------------------------------------------------*/
void mostrarC(int x, int y, WORD atributos, long valor)
{
	HANDLE hConsole;			// Handle para a janela
	COORD coord = { x, y };		// Posição do cursor
	DWORD dChar;				// Número de caracteres impressos
